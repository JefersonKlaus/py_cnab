...
from src import (
    CnabGenerator,
    Cnab150EmpresaData, Cnab400EmpresaData,
    DebitoAutomaticoData, PagadorData, CobrancaData,
    Cnab150Request, Cnab400Request
)
...
def exemplo_cnab_400():
    ...
    try:
        ...
        empresa = Cnab400EmpresaData(
            codigo_empresa="1234567",
            nome_empresa="EMPRESA COBRANCA LTDA"
        )
        ...
        request = Cnab400Request(
            nsa=73,  # Baseado no exemplo original
            empresa=empresa,
            cobrancas=cobrancas
        )
