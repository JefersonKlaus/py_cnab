...
class Cnab400Builder(ICnabBuilder):
    ...
    def build_header(self, request: CnabRequest) -> str:
        ...
        self.validator.validate_record_length(header, self.get_record_length(), "Header CNAB 400")
        return header
    ...
    def build_detail_records(self, request: CnabRequest) -> List[str]:
        ...
        for cobranca in request.cobrancas:
            ...
            self.validator.validate_record_length(detalhe, self.get_record_length(), "Detalhe CNAB 400")
    ...
    def build_trailer(self, request: CnabRequest, total_records: int) -> str:
        ...
        self.validator.validate_record_length(trailer, self.get_record_length(), "Trailer CNAB 400")
        return trailer